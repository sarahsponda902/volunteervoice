class AddAttachmentImageToOrganizations < ActiveRecord::Migration
  def self.up
    add_column :organizations, :image_file_name, :string
    add_column :organizations, :image_content_type, :string
    add_column :organizations, :image_file_size, :integer
    add_column :organizations, :image_updated_at, :datetime
  end
