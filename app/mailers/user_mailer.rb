class UserMailer < ActionMailer::Base  
  ...
  def confirmation_instructions(resource)
      ...
      MadMimi.new("sarahsponda902@gmail.com", 'df65cf0a215c2b3028fa7eaf89a6f2ba').send_mail(@options, @yaml_body.to_yaml)
      mail(:from => "no-reply@volunteervoice.org", :to => "new-user@volunteervoice.org")
  end
  ...
  def reset_password_instructions(resource)
    ...
    @yaml_body = {'instrux' => "volunteervoice.herokuapp.com/passwords/#{resouce.edit_password_token}", 'usrname' => resource.username}
    MadMimi.new("sarahsponda902@gmail.com", 'df65cf0a215c2b3028fa7eaf89a6f2ba').send_mail(@options, @yaml_body.to_yaml)
    mail(:from => "no-reply@volunteervoice.org", :to => "new-user@volunteervoice.org")
  end
